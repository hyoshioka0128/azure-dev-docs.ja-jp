...
1. [Oracle のドキュメント](https://aka.ms/arm-oraclelinux-wls-cluster-oracle-docs)で説明されている、WebLogic Server クラスターをプロビジョニングする手順に従うことから始めますが、次に示す **[Azure Application Gateway]** ブレードに達したら、このページに戻ります。
