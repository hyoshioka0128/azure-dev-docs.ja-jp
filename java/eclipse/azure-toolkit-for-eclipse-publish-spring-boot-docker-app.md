---
title: Spring Boot アプリを Docker コンテナーとして発行する
...
ms.locfileid: "75191119"
---
# <a name="publish-a-spring-boot-app-as-a-docker-container-by-using-the-azure-toolkit-for-eclipse-deprecated"></a>Azure Toolkit for Eclipse を使用して Spring Boot アプリを Docker コンテナーとして発行する (非推奨)
...
次の手順では、IntelliJ を使用して、ローカル コンピューターに Spring Boot Docker リポジトリを複製する方法について説明します。 コマンド ラインを使用したい場合は、[Azure Container Service で Spring Boot アプリケーションを Linux にデプロイする方法][Deploy Spring Boot on Linux in AKS]に関するページを参照してください。
