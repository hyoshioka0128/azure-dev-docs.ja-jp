...
## <a name="authenticate-with-a-json-file"></a><a name="mgmt-auth-file"></a>JSON ファイルを使用した認証
...
## <a name="authenticate-with-token-credentials"></a><a name="mgmt-auth-token"></a>トークン資格情報による認証
...
### <a name="authenticate-with-token-credentials-deprecated"></a><a name="mgmt-auth-legacy"></a>トークン資格情報による認証 (非推奨)
...
## <a name="authenticate-with-azure-managed-identities"></a><a name="mgmt-auth-msi"></a>Azure マネージド ID を使用して認証する
...
## <a name="cli-based-authentication-development-purposes-only"></a><a name="mgmt-auth-cli"></a>CLI ベースの認証 (開発目的のみ)
